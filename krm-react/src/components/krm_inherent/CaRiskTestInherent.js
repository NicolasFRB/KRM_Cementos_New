...
function CaRiskTestInherent({ pk, initialImpact, initialProbability, initialEventSpeed, initialDescriptionAdmin }) {
  ...
  const updateProbability = (newProbability) => {
    ...
    fetch(`${configService.apiSendRiskTestInherent}?pk=${pk}&adminProbability=${newProbability}`)
      .then((res) => res.json())
      .then(
        (res) => {
  ...
  const updateImpact = (newImpact) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestInherent}?pk=${pk}&adminImpact=${newImpact}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateEventSpeed = (newEventSpeed) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestInherent}?pk=${pk}&adminEventSpeed=${newEventSpeed}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateDescriptionAdmin = (newDescriptionAdmin) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestInherent}?pk=${pk}&descriptionAdmin=${newDescriptionAdmin}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
...
export default CaRiskTestInherent;
