...
function RuRiskTestResidual({ pk, initialImpactReputational, initialImpactEconomic, initialImpactRegulatory, initialImpactObjectives, initialImpactDedication, initialProbability, initialEventSpeed, initialDescription }) {
  ...
  const updateImpactReputational = (newImpactReputational) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestResidual}?pk=${pk}&impactReputational=${newImpactReputational}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateImpactEconomic = (newImpactEconomic) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestResidual}?pk=${pk}&impactEconomic=${newImpactEconomic}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateImpactRegulatory = (newImpactRegulatory) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestResidual}?pk=${pk}&impactRegulatory=${newImpactRegulatory}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateImpactObjectives = (newImpactObjectives) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestResidual}?pk=${pk}&impactObjectives=${newImpactObjectives}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateImpactDedication = (newImpactDedication) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestResidual}?pk=${pk}&impactDedication=${newImpactDedication}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
  ...
  const updateEventSpeed = (newEventSpeed) => {
    $('#buttonSend').attr('data-kt-indicator', 'on');
    fetch(`${configService.apiSendRiskTestResidual}?pk=${pk}&eventSpeed=${newEventSpeed}`)
      .then((res) => res.json())
      .then(
        (res) => {
          $('#buttonSend').attr('data-kt-indicator', 'off');
    ...
    <div className="valoration">
      ...
      <div className="row">
        <div className="form-group">
          <label htmlFor={`id-description--${pk}`} className=""><h5>{t('krmResidual.description-value-evaluator')} (*)</h5></label>
