...
@method_decorator((login_required, is_auditor,  user_can_view_control_test), name="dispatch")
class AuControlTestDetail(FormView):
    template_name = 'control_tests/au/AuControlTestDetail.html'
