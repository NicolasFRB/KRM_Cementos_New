...
@method_decorator([login_required, is_global_admin, ], name='dispatch')
class GaEvaluationDetailView(FormView):
...
class EvaluationAssignImport(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        return super(EvaluationAssignImport, self).dispatch(
    ...
    def form_valid(self, form):
        ...
        for row in range(control_test_sheet.nrows):
            if row > 0:
                ...
                if control_test.evaluation != self.evaluation:
                    ...
                    return super(EvaluationAssignImport, self).form_invalid(form)
                    break
                #  Comprobamos que el control owner existe y que pertenecen a la compañía del Test de Proceso
        ...
        return super(EvaluationAssignImport, self).form_valid(form)
