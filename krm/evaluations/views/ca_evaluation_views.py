...
class CaEvaluationDetailView(DetailView, FormView):
    model = Evaluation
    ...
    def get_context_data(self, **kwargs):
        ...
        context['actions'] = [
            {
                'title': _('Editar'),
                'url': reverse('evaluations:ca_evaluation_update', kwargs={'pk': self.object.pk}),
                'primary': True,
    ...
    def form_valid(self, form):
        ...
        if type(form) is EvaluationTemplateAssignDownload:
            ...
            filename = "{} template_asign_process.xls".format(evaluation.pk)
