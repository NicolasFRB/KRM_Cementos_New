...
class CaEvaluationResidualListView(ListView):
    model = EvaluationKrmResidual
    template_name = 'evaluations_krm/CaEvaluationResidualList.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['actions'] = [
            {
                'title': _('Nuevo'),
                'url': reverse('evaluations_krm:ca_evaluation_residual_create'),
                'primary': True,
...
@method_decorator([login_required, is_company_admin, ], name='dispatch')
class CaEvaluationResidualCreateView(FormView):
    form_class = EvaluationResidualCreateForm
    model = EvaluationKrmResidual
    template_name = 'evaluations_krm/CaEvaluationResidualCreate.html'
    ...
    def form_valid(self, form):
        ...
        for rc in risk_companies:
            ...
            for e in evaluations:
                ...
                #e.create_risk_company_residual() Comentario usado para crear Riesgos de Compañía Residuales para cada evaluación
...
@method_decorator([login_required, is_company_admin, user_can_view_evaluation_residual], name='dispatch')
class CaEvaluationResidualDetailView(FormView):
    template_name = 'evaluations_krm/CaEvaluationResidualDetail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['page_title'] = f"{_('Evaluación de Riesgo Residual KRM')} : {self.evaluation.ref}"
        context['breadcrums'] = breadcrums
        ...
        context['rrt'] = RiskTestResidual.objects.filter(evaluation=self.evaluation)
    ...
    def form_valid(self, form):
        ...
        if action == 'download':
            ...
            tests_columns=[
                ...
                "Lateste inherent assessment justification",
    ...
    def get_success_url(self):
        return reverse_lazy(
            "evaluations_krm:ca_evaluation_residual_detail",
            kwargs={"pk": self.evaluation.pk},
        )


@method_decorator([login_required, is_company_admin, user_can_view_evaluation_residual], name='dispatch')
class CaEvaluationResidualAdminComplete(DetailView, FormView):
    template_name = 'evaluations_krm/CaEvaluationResidualAdminComplete.html'
    model = EvaluationKrmResidual
    ...
    def get_context_data(self, **kwargs):
        """
        Función que envía al template html al cual está relacionado esta vista información
        de provecho para poder acceder a ella y visualizarla por pantalla.
        """
        context = super().get_context_data(**kwargs)
        context = KTLayout.init(context)
        ...
        context['tests']= self.object.risk_test_residuals.all()
        context['js_template'] = ['js/custom/datatables.js'] #es necesario enviar esto en el contexto?
